...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["rmappo", "mappo", "ippo", "happo", "hatrpo", "mat", "mat_dec"])
    ...
    parser.add_argument("--use_mps", action='store_true', default=True, help="by default True, will automatically use Apple MPS if available on Mac")
    parser.add_argument("--n_training_threads", type=int,
                        default=16, help="Number of torch threads for training (optimized for M4 Max)")
    parser.add_argument("--n_rollout_threads", type=int, default=48,
                        help="Number of parallel envs for training rollouts (optimized for M4 Max)")
