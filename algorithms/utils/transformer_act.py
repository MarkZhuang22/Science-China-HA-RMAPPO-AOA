...
"""
Transformer Action Processing - MPS Optimized for Apple Silicon
============================================================
- Categorical和Normal分布在MPS上表现优异
- One-hot编码和矩阵运算已针对Apple Silicon优化
"""
...
def discrete_autoregreesive_act(decoder, obs_rep, obs, batch_size, n_agent, action_dim, tpdv,
    ...
    """MPS优化：离散自回归动作处理"""
    # MPS优化：确保张量在正确设备上且连续
    shifted_action = torch.zeros((batch_size, n_agent, action_dim + 1), **tpdv).contiguous()
