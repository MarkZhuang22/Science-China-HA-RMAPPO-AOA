...
"""RNN modules optimized for Apple Silicon MPS."""
...
class RNNLayer(nn.Module):
    def __init__(self, inputs_dim, outputs_dim, recurrent_N, use_orthogonal):
        ...
        # MPS优化：GRU在Apple Silicon上有很好的性能
        self.rnn = nn.GRU(inputs_dim, outputs_dim, num_layers=self._recurrent_N, batch_first=False)
